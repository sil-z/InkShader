...
export const CanvasDispatcher = Object.freeze({
    ...
    requestBooleanIntersection() { emitRequest(CANVAS_EVENTS.REQUEST_BOOLEAN_INTERSECTION); },
    requestBooleanDifference() { emitRequest(CANVAS_EVENTS.REQUEST_BOOLEAN_DIFFERENCE); },
    requestBooleanExclusion() { emitRequest(CANVAS_EVENTS.REQUEST_BOOLEAN_EXCLUSION); },
    requestExpandStroke() { emitRequest(CANVAS_EVENTS.REQUEST_EXPAND_STROKE); },
    requestInsertNode() { emitRequest(CANVAS_EVENTS.REQUEST_INSERT_NODE); },
    requestDeleteNode() { emitRequest(CANVAS_EVENTS.REQUEST_DELETE_NODE); },
    requestJoinNode() { emitRequest(CANVAS_EVENTS.REQUEST_JOIN_NODE); },
    requestBreakNode() { emitRequest(CANVAS_EVENTS.REQUEST_BREAK_NODE); },
    requestAddSegment() { emitRequest(CANVAS_EVENTS.REQUEST_ADD_SEGMENT); },
    requestDeleteSegment() { emitRequest(CANVAS_EVENTS.REQUEST_DELETE_SEGMENT); },
    requestUnlink(ids = []) { emitRequest(CANVAS_EVENTS.REQUEST_UNLINK, { ids }); },
    requestAddExtrema() { emitRequest(CANVAS_EVENTS.REQUEST_ADD_EXTREMA); },
    requestSimplifyPath() { emitRequest(CANVAS_EVENTS.REQUEST_SIMPLIFY_PATH); },
