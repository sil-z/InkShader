...
export const CANVAS_EVENTS = Object.freeze({
    ...
    REQUEST_MARK_GROUP_EXPLICIT: "request-mark-group-explicit",
    ...
    REQUEST_ADD_EXTREMA: "request-add-extrema",
    REQUEST_SIMPLIFY_PATH: "request-simplify-path",
    REQUEST_OPTIMIZE_PATH: "request-optimize-path",
    REQUEST_ROUND_NODES: "request-round-nodes",
    REQUEST_SMOOTH_CURVES: "request-smooth-curves",
    REQUEST_CORRECT_DIRECTION: "request-correct-direction",
    REQUEST_REMOVE_OVERLAP: "request-remove-overlap",
    REQUEST_IMPORT: "request-import",
    REQUEST_SAVE: "request-save",
    REQUEST_SAVE_AS: "request-save-as",
